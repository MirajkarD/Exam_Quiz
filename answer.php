            ...
            <div class="lg:flex lg:space-x-4 mt-4 mx-4">
                <div class="lg:w-8/12 lg:mt-0 mt-4">
                    ...
                    ?>
                                ...
                                echo '<div style="border-radius:none mt-0" class="tube-card z-20 mb-4 overflow-hidden uk-sticky " uk-sticky="cls-active:rounded-none ; media: 992 ; offset:70">
                                <nav class="flex justify-between px-4 py-2">
                                    <button id="countdown" class="bg-yellow-500 hover:bg-yellow-500 text-black font-bold hover:text-black py-2 px-4 border border-yellow-500 hover:border-transparent rounded">20:20</button>
